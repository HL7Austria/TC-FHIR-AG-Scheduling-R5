...
<table>
  ...
  <tbody>
    ...
    <tr>
        ...
        <td><a href="search.html#date">date</a></td><td>Appointment date/time.</td>
        <td>(start | requestedPeriod.start).first()</td><td><a href="searchparameter-registry.html#clinical-date">27 Resources</a></td>
    </tr>
  </tbody>
</table>