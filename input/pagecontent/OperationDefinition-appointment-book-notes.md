...
<h5> Examples </h5>
<h5> Request the booking of an appointment </h5>

{% include examples/Appointment-operationBook-request.md %}

Response to the book request:

{% include examples/Appointment-operationBook-response.md %}