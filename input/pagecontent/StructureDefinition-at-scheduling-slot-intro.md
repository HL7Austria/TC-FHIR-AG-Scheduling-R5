...
This Profile is used in the [Find available Slots for potential Appointments](functional-transactions.html#find-available-slots-for-potential-appointments).
